...
- **Bio:** Full-stack developer building web products, cloud systems, and applied AI. University of Moratuwa CSE · Maple Wraps & ForkNetRT.
- **Website:** https://kavindudamsith.tech/
- **Location:** Sri Lanka
- **Contact:** kavindudamsith65@gmail.com
- **LinkedIn:** https://www.linkedin.com/in/kavindu-damsith-86696722a/

## Pin shortlist

Lead with PlateShare, healthLink, VsrPipelineV2, trainGpsv3, routeOptima, and the Me portfolio repository. Feature the private commercial projects through their portfolio case studies.

## What this draft improves
...
Content was checked against the two CV PDFs supplied in the conversation, the current portfolio, and authenticated GitHub reads. The portfolio domain was returned by the Me repository's GitHub Pages configuration on 5 September 2026.
